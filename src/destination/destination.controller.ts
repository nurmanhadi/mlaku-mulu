...
export class DestinationController {
  ...
  async findById(
    ...
    const result = await this.desService.findDestinationById(
      touristId,
      tripId,
      desId,
    );
  ...
  async create(
    ...
    const result = await this.desService.createDestination(
      touristId,
      tripId,
      req,
    );
  ...
  async update(
    ...
    const result = await this.desService.updateDestination(
      touristId,
      tripId,
      desId,
      req,
