import { HttpException, Injectable, Next } from "@nestjs/common";
...
export class TouristService {
    ...
    async findAllTourist(page: number, perPage: number): Promise<TouristResponse[]> {
    ...
    async createTourist(req: CreateTouristDto): Promise<TouristResponse> {
        ...
        const existPasportNumber = await this.touristRepository.existPasportNumber(req.passportNumber)
    ...
    async updateTourist(id: string, req: UpdateTouristDto): Promise<TouristResponse> {
